package("openxr-sdk")
    ...
    add_urls("https://github.com/KhronosGroup/OpenXR-SDK/archive/refs/tags/$(version).tar.gz",
             "https://github.com/KhronosGroup/OpenXR-SDK.git")

    add_versions("release-1.1.49", "74e9260a1876b0540171571a09bad853302ec68a911200321be8b0591ca94111")
    ...
    on_install(function (package)
        ...
        table.insert(configs, "-DBUILD_CONFORMANCE_TESTS=OFF")
